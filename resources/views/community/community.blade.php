@extends('layouts.community.app')
  @section('content')
               ...
               <div class="row align-items-center top-button">
                 <div class="col-md-auto d-flex justify-content-between px-0">
                   <div class="col-md-auto col-sm-4">
                     <button type="button" class="btn post active me-md-5 me-4" data-bs-toggle="modal" data-bs-target="#postModal">
                  ...
                  <div class="com-cardwrapper mx-0">
                    <div class="com-card">
                      ...
                      <div class="d-flex lower-card">
                        <div class="col-auto">
                          <span class="likes">
                            <img src="{{ asset('icons/heart.svg')}}" class="heart-shape" alt="heart" data-post-id="{{ $post->id }}" data-user-id="{{ Auth::user()->id }}" data-likes="{{ $post->likes }}" />
                  ...
                  <div class="form-group" style="margin-bottom: 2rem; margin-top: -3rem">
                    ...
                    <div class="content">
                      <form action="/store-comment/{{$post->id}}" method="POST">
                        ...
                        <textarea name="comment" class="form-control mt-2" id="exampleFormControlTextarea1" rows="2" placeholder="Type a comment" style="border-radius: 5px"></textarea>

                        <button type="submit" class="btn submit-reg" style="margin-left: 40rem; margin-top: 0.5rem">Comment</button>
                      </form>
    ...
    <!-- modal  -->
    <div class="modal fade" style="display: none" id="postModal"  tabindex="-1" aria-labelledby="postModalLabel" aria-hidden="true">
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form action="/store-post" method="POST">
              ...
              <div class="form-group">
                <textarea name="body" id="" cols="30" rows="10" class="form-control" placeholder="Enter Post"></textarea>
              </div>
