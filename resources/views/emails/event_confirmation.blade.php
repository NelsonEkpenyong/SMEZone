  ...
  <body>
    ...
    >
      <tr>
        <td colspan="2">
          <img
            src="https://accessmezone.com/img/smelogo.png"
            alt="smeLogo"
            style="
              height: 36px;
              width: 134.77px;
      ...
      <tr>
        <td colspan="2" style="text-align: center">
          <div>
            <img
              src="https://accessmezone.com/img/registration_confirmation.png"
      ...
      <tr>
        ...
        >
          ...
          <p style="margin-top: 1.5rem">
           Thank you for registering for the upcoming <i><b>{{$event}}</b></i>. We are thrilled to have you join us for this exciting event. 
          </p>
          <p style="margin-top: 1.5rem">
           This email serves as a confirmation of your successful registration.
          </p>

          <p style="margin-top: 2rem">Event Details:</p>

          <p style="margin-top: 2rem">
           Event Name: {{$event}}
          </p>
          <p style="margin-top: 1rem">
           Event Date: {{$humanReadableDate}}
          </p>
          <p style="margin-top: 1rem">
          ...
          <div>
            <div style="position: relative">
              <div style="text-align: center; width: 100%">
                <img
                  src="https://accessmezone.com/img/Socials.png"
                  alt=""
                  style="
                    max-width: 100%;
                    height: auto;
              ...
              >
                ...
                >
                  <img
                    src="https://accessmezone.com/img/sme_logo_footer.png"
                    alt=""
              ...
              <div class="d-flex align-items-end justify-content-between">
                <img
                  src="https://accessmezone.com/img/left.png"
                  alt=""
                  style="width: 153px; height: auto"
                />

                <img
                  src="https://accessmezone.com/img/right.png"
                  alt=""
