...
{{$course}}
  ...
  <div class="container">
    ...
    <div class="confirmation_image">
      <img src="{{ asset('img/registration_confirmation.png')}}" alt="">
    </div>
    ...
    <div class="letter">
      ...
      <p class="letter_text">
        Thank you for registering for the upcoming [Event Name]. We are thrilled to have you join us for this exciting event. 
      ...
      <p>
        ...
        Event Location: [Event Location/Online Platform]<br>
      </P>
      <p>
        We look forward to seeing you at [Event Name]. It promises to be an engaging and insightful occasion. 
        Remember to add this event to your calendar: Google. Outlook. iCal. Yahoo 
      </p>
