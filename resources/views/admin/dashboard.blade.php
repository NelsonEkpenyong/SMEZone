    ...
    @section('content')
      ...
      <div class="row">
        <div class="col-md-12 grid-margin transparent">
           ...
           <div class="col-md-3 mb-4 stretch-card transparent">
            ...
            <div class="col-md-3 mb-4 stretch-card transparent">
              ...
              <div class="card font-weight-bold" style="background: #ee2d24; color: white">
                <div class="card-body">
                  <a href="{{route('manage')}}" style="text-decoration: none; color: inherit;">
                    <p class="mb-4">Events</p>
                    <p class="fs-30 mb-2">{{$eventCount}}</p>
                    <p>22.00% (30 days)</p>
                  </a>
                </div>
              </div>
          ...
          <div class="row">
            <div class="col-md-3 mb-4 stretch-card transparent">
              <div class="card  card-light-danger font-weight-bold">
                <div class="card-body">
     ...
     {{--  <div class="row"> <!---Order Details--->
        <div class="col-md-6 grid-margin stretch-card">
          <div class="card">
            <div class="card-body">
              <p class="card-title">Event Report</p>
              ...
              <div class="d-flex flex-wrap mb-5">
                ...
                <div class="mr-5 mt-3">
                  <p class="text-muted">Attended Events</p>
          ...
          <div class="card">
            <div class="card-body">
             <div class="d-flex justify-content-between">
              <p class="card-title">Course Report</p>
                    ...
                    <div class="row">
                      <div class="col-md-12 col-xl-3 d-flex flex-column justify-content-start">
                        <div class="ml-xl-4 mt-3">
                          <p class="card-title">Enrolled Courses</p>
                          <h1 class="text-primary">34040</h1>
                          <h3 class="font-weight-500 mb-xl-4 text-primary">Offline</h3>
